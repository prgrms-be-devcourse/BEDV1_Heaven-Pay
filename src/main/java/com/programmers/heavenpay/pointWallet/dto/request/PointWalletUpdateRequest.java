...
public class PointWalletUpdateRequest {
    ...
    protected PointWalletUpdateRequest() {
    }

    public PointWalletUpdateRequest(Long memberId, Long accountId, Integer walletPoint) {
